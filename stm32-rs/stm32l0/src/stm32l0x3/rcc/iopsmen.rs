...
///Field `IOPHSMEN` reader - IOPHSMEN
pub type IOPHSMEN_R = IOPASMEN_R;
///Field `IOPHSMEN` writer - IOPHSMEN
...
///Field `IOPDSMEN` reader - IOPDSMEN
pub type IOPDSMEN_R = IOPASMEN_R;
///Field `IOPDSMEN` writer - IOPDSMEN
...
///Field `IOPCSMEN` reader - IOPCSMEN
pub type IOPCSMEN_R = IOPASMEN_R;
///Field `IOPCSMEN` writer - IOPCSMEN
...
///Field `IOPBSMEN` reader - IOPBSMEN
pub type IOPBSMEN_R = IOPASMEN_R;
///Field `IOPBSMEN` writer - IOPBSMEN
...
///Field `IOPASMEN` reader - IOPASMEN
...
///Field `IOPASMEN` writer - IOPASMEN
