...
pub struct NZDISABLE_R(crate::FieldReader<bool, bool>);
impl NZDISABLE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        NZDISABLE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for NZDISABLE_R {
...
pub struct NZDISABLE_W<'a> {
    w: &'a mut W,
}
impl<'a> NZDISABLE_W<'a> {
    ///Sets the field bit
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn nzdisable(&self) -> NZDISABLE_R {
        NZDISABLE_R::new(((self.bits >> 23) & 0x01) != 0)
    }
}
impl W {
    ///Bit 0 - FLASH_PECR and data EEPROM lock
    ...
    ///Bit 23 - Non-Zero check notification disable
    #[inline(always)]
    pub fn nzdisable(&mut self) -> NZDISABLE_W {
        NZDISABLE_W { w: self }
    }
