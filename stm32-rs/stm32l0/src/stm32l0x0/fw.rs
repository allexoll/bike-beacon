...
///CSSA register accessor: an alias for `Reg<CSSA_SPEC>`
pub type CSSA = crate::Reg<cssa::CSSA_SPEC>;
///Code segment start address
pub mod cssa;
///CSL register accessor: an alias for `Reg<CSL_SPEC>`
pub type CSL = crate::Reg<csl::CSL_SPEC>;
///Code segment length
pub mod csl;
///NVDSSA register accessor: an alias for `Reg<NVDSSA_SPEC>`
pub type NVDSSA = crate::Reg<nvdssa::NVDSSA_SPEC>;
///Non-volatile data segment start address
pub mod nvdssa;
///NVDSL register accessor: an alias for `Reg<NVDSL_SPEC>`
pub type NVDSL = crate::Reg<nvdsl::NVDSL_SPEC>;
///Non-volatile data segment length
pub mod nvdsl;
///VDSSA register accessor: an alias for `Reg<VDSSA_SPEC>`
pub type VDSSA = crate::Reg<vdssa::VDSSA_SPEC>;
///Volatile data segment start address
pub mod vdssa;
///VDSL register accessor: an alias for `Reg<VDSL_SPEC>`
